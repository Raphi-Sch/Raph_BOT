...
// List option
$result = db_query_raw($db, "SELECT tanks.key FROM tanks ORDER BY tanks.key ASC");
$options_tanks = "";
while($row = mysqli_fetch_assoc($result)) {
    $options_tanks .= '<option>'.$row["key"].'</option>';
}
    ...
    <script>
      ...
      function del_entry(key){
        Swal({
          ...
          if (result.value) {
              $.post("alias_tanks.php", { action : "del", key: key }, function(data){
